    ...
    <main>
      ...
      <section id="about" className="about-section section-pad">
        ...
        <div className="about-grid">
          ...
          <div className="about-copy"><p>I'm Arjun, a product designer working across UI/UX, interaction design and visual communication. I use field research, journey mapping and prototypes to turn evidence into clearer decisions.</p><dl><div><dt>NOW</dt><dd>UX Design Intern<br/><small className="about-subtext">Experion Technologies</small></dd></div><div><dt>BASED</dt><dd>Kerala, India<br/>Open to junior product design opportunities</dd></div><div><dt>EXPERIENCE</dt><dd>2+ years across product, brand and digital communication</dd></div><div><dt>EDUCATION</dt><dd>B.Tech in Artificial Intelligence & Machine Learning<br/><small className="about-subtext">Marian Engineering College, affiliated to APJ Abdul Kalam Technological University</small></dd></div></dl></div>
        </div>
      </section>
